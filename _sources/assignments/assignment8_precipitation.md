...
### Problem 2 - Thompkins and Walace and Hobbs 6.23
...
### Problem 3  -- Wallace and Hobbs problem 6.21 -- analytic derivation -- constant updraft
...
Frist use {ref}`eq:height` to solve the following problem, then compare it to the odeint solution the itegrates the differential equations for `[h, R]`, stopping when $h=0$  (either by trial and error, or using the approach from
{ref}`sec:rkintegrator`
