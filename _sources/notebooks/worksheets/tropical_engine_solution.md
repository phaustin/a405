...
(tropical_engine_solution)=
# Tropical Heat Engine 

The link to [tropical_engine_solution.ipynb](https://drive.google.com/file/d/1mCpXEO7Bl4zDGVwhDhw_l6H3noRMZbY4/view?usp=sharing)
...
## This notebook:
  ...
  3\. Finds the percentage of the total heat change that is due to addition and remove of water
     during the cycle.
