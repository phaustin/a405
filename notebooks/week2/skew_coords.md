...
The University of Wyoming maintains a public archive of balloon sounding data at [https://weather.uwyo.edu/upperair/sounding.shtml](https://weather.uwyo.edu/upperair/sounding.shtml)
...
- stnm is the station number from the website
...
The function [a405.soundings.wyominglib.read_soundings](https://phaustin.github.io/a405_lib/_modules/a405/soundings/wyominglib.html#read_soundings) takes a variable with the directory name and reads all of the csv files into [pandas dataframes](https://foundations.projectpythia.org/core/pandas/pandas/)
...
In cells below, we add the temperature and dewpoint soundings for the Feb 1, 2013 brazil sounding to this plot
