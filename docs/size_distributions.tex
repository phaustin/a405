...
\begin{equation}
  \label{eq:reff}
  r_{eff}= \frac{\int_0^\infty r \left [ 4\pi  r^2 n(r) \right ] dr}%
              {\int_0^\infty  \left [ 4\pi  r^2 n(r) \right ] dr}
...
the radiative effect of aerosols on the planetary energy balance and in aerosol remote sensing.
\end{document}
