...
Wallace and Hobbs give several examples of histograms of aerosol
number concentration as a function of aerosol radius (e.g.~5.9,
...
Although we don't need it  here,  Leibniz' rule for the total differential of an integral 
of a two-dimensional function is also a good thing to know:

\begin{equation}
  \label{eq:lieb}
  \frac{d}{dx} \int_A^B f(x,t) dt = \int_A^B \frac{\partial f}{\partial x} dt + f(x,B) \frac{dB}{dx}
      - f(x,A) \frac{dA}{dx}
\end{equation}

Given the above we can see that the W\&H plot of $-dN/d\log r$ vs $d\log r$ still
