...
Thompkins p. 30 equation defines the virtual temperature.  Note that his version
is only for dry air plus vapor.  In contrast, 
in Chapter 1 of  Stull (1.5.1a) on p.~7 there is a definition that includes
the liquid water mixing ratio $r_l$.  In this note we show where that comes from
using Taylor series.
