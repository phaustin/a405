...
\lhead{Liquid water static energy and moist entropy}
\chead{}
...
Here's a general review of what we've done so far with thermo, and an extension to include
the effects of moisture on the static energy and entropy.
...
and get the general  expression for enthalpy:
...
\begin{equation}
  \label{eq:s}
d\phi = \frac{q dt}{T} = \frac{c_p}{T} dT + \frac{l_v}{T} d r_{sat} - 
\frac{R_d}{p} dp
\end{equation}
