...
\item The figure below shows typical aerosol 
    ...
    \begin{figure}[H]
      \begin{center}
        \leavevmode
  \includegraphics[width=6in]{finalfigs/aero}
        \label{fig:aer}
    \caption{$ $}
      \end{center}
    \end{figure}
...
\includegraphics{finalfigs/chamber}
...
\includegraphics[width=0.8\textwidth]{finalfigs/finalfig}
...
size distributions and the K\"ohler curve to explain 1-3.
    ...
    \begin{figure}[H]
      \begin{center}
        \leavevmode
  \includegraphics[width=6in]{finalfigs/supersat}
        \label{fig:supersat}
    \caption{$ $}
      \end{center}
    \end{figure}
...
\begin{enumerate}
\item[P1]  Suppose you put 1 kg of liquid water in a sealed 5 liter container 
...
\item[P2] Write python function that would evaluate derivatives needed to
...
infinite reservoir at the same temperature.  You put a liter of liquid water (again at the same temperature) in each and
