...
bot=ax.plot(xplot, press_800*pa2hPa, 'bd', max[rkersize=14, markerfacecolor='b')
#
```
...
print('temperature and pressure of LCL is {} C and {} hPa'.format(n(k2c(Tlcl)),n(plcl*1.e-2)))
#
